...
dockerbuildpush:
	docker buildx build --platform linux/amd64,linux/arm64,linux/arm/v7 --push -t brlbil/csi-lvmplugin-provisioner:${DOCKER_TAG} . -f cmd/provisioner/Dockerfile
	docker buildx build --platform linux/amd64,linux/arm64,linux/arm/v7 --push -t brlbil/lvmplugin:${DOCKER_TAG} .
